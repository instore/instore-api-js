...
(function() {
  ...
  Instore.Orders = (function(_super) {
    ...
    Orders.prototype.refund = function(id, callback) {
      ...
      options.url = "" + (this.path()) + "/" + id + "/refund";
      options.data = params;
      options.type = 'POST';
      return $.ajax(options);
    };
    ...
    Orders.prototype.hold = function(id, params, callback) {
      ...
      options.url = "" + (this.path()) + "/" + id + "/hold_order";
      options.data = params;
      options.type = 'POST';
      return $.ajax(options);
    };
    ...
    Orders.prototype.unhold = function(id, callback) {
      ...
      options.url = "" + (this.path()) + "/" + id + "/unhold_order";
      options.data = params;
      options.type = 'POST';
      return $.ajax(options);
    };
    ...
    Api.prototype.login = function(callback) {
      ...
      return oauthInterval = window.setInterval(function() {
        ...
        if (match = hash.match('access_token=([^&]*)')) {
          ...
          _this.setCookie(_this.cookieName, _this.accessToken, 365);
          popup.close();
          window.clearInterval(oauthInterval);
          if (callback) {
            callback();
